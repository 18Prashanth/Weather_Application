...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        self.tempearture_label = QLabel(self)
    ...
    def initUI(self):
        ...
        vbox.addWidget(self.tempearture_label)
    ...
    def get_weather(self):
        api_key = "e0729ca224717d4497f273534d806c7b"
    ...
    def display_weather(self, data):
        ...
        self.tempearture_label.setText(f"{temperature_c:.0f}­°C")
